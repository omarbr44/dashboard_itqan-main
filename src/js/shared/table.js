      ...
      this.innerHTML = `
        <div class="relative py-5 overflow-x-auto shadow-md sm:rounded-lg">
          ...
          <div class="relative overflow-x-auto sm:rounded-lg">
            <div class="flex items-center justify-between flex-column mb-3 p-5 flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white dark:bg-gray-900">
              ...
              <div class="flex gap-x-2">
                ...
                <div class="relative">
                  ...
                  <input type="text" id="table-search-users" class="block p-[10px] px-[14px] ps-10 text-sm text-gray-900 border border-[#EBEBEC] rounded-lg w-80 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:ring-0 focus:border-[#EBEBEC]" placeholder="بحث"/>
                </div>
              </div>
            </div>
                  ...
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ${Object.values(row)
                      .map(
                        (cell) => `
                      <td class="px-6 py-4">
                        ${row?.name === cell && this.getAttribute('img')
                          ? `
                            <div class="flex items-center text-gray-900 whitespace-nowrap dark:text-white">
                              <img class="w-10 h-10 rounded-full" src="${this.getAttribute('img')}" alt="Jese image"/>
                              <div class="ps-3">
            ...
            <!-- Pagination and Modals (same as before) -->
          </div>
        </div>
      `;
